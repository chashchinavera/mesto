...
//Buttons
const elementLikeButtonElement = document.querySelector('.element__like');
...
//Functions
const activeElementLike = function () {
    elementLikeButtonElement.classList.toggle('element__like_active');
}
...
elementLikeButtonElement.addEventListener('click', activeElementLike);